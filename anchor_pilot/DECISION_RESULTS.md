...
[Detailed staged follow-up and stop conditions](DECISION_NEXT_STEPS.md). No further GPU session was started.
...
[Complete comparison table](evidence/decision/decision_comparison.csv) · [Machine-readable decisions and failed gates](evidence/decision/decision_analysis.json) · [Delivery audit](evidence/decision/delivery_audit.json)

[Feature screening and readout cosines](evidence/decision/feature_screen.csv) · [Fitted SAE coefficients](evidence/decision/selected_feature_coefficients.csv) · [Direction alignment](evidence/decision/direction_alignment.csv) · [Locked analysis source manifest](evidence/decision/analysis_manifest.json)

![Fresh original wording](evidence/decision/decision_curves_original.png)

![Fresh alternative wording](evidence/decision/decision_curves_transfer.png)
