...
- Raw saved ultimatum-game and trust-game outputs with non-GPU source audits.
...
| Ultimatum Open-SAE replacement | Loader and source audit complete, GPU rerun pending | 2,040 saved units, 51 behavior cells, old `feature_activations.txt` parsed |
| Trust-game Open-SAE replacement | Loader and source audit complete, GPU rerun pending | 200 saved units, 20 behavior cells |
